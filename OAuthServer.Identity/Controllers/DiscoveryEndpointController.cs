...
using OAuthServer.Identity.Endpoints;
    ...
    public class DiscoveryEndpointController : Controller
    {
        ...
        public JsonResult GetConfiguration()
        {
            var response = new DiscoveryResponse
            {
                ...
                authorization_endpoint = "https://localhost:5056/Home/Authorize",
                token_endpoint = "https://localhost:5056/Home/Token",
                ...
                service_documentation = "https://localhost:5056/connect/service_documentation.html",
